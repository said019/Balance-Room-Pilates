          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            {isAuthenticated ? (
              <>
                ...
                <Button variant="hero" size="lg" asChild className="bg-balance-olive hover:bg-balance-olive/90">
                  <a href="#horarios">Reservar clase</a>
                </Button>
              </>
            ) : (
              <>
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 pt-6 pb-4">
            <div className="flex items-center gap-2">
              <img src="/balance-room-logo-transparent.png" alt="Balance Room" className="h-10 w-auto object-contain" />
              <span className="font-heading text-lg font-semibold text-white">Balance Room</span>
            </div>
            <button
              onClick={() => setIsMobileMenuOpen(false)}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 16px) + 16px)' }}>
            <Button 
              variant="hero" 
              size="lg" 
              className="w-full bg-white text-balance-olive hover:bg-white/90 font-semibold text-base h-12 rounded-xl shadow-lg" 
              asChild
            >
