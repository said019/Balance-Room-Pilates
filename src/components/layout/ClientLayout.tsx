                ...
                <div className="container flex h-16 items-center justify-between">
                    ...
                    <Link to="/app" className="flex items-center space-x-3">
                        ...
                        <div className="flex items-baseline space-x-1">
                            <span className="font-heading text-xl font-bold text-primary">Balance Room</span>
                            <span className="font-heading text-sm text-muted-foreground">Pilates</span>
                        </div>
                    </Link>
                        ...
                        return (
                            <Link
                                ...
                                className={cn(
                                    ...
                                    isActive ? 'text-balance-gold' : 'text-muted-foreground'
                                )}
                            >
                                <div className={cn(
                                    'p-1.5 rounded-xl transition-all duration-200',
                                    isActive ? 'bg-balance-gold/10 scale-110' : ''
                                )}>
                                    <Icon className="h-5 w-5" />
                                </div>
                                <span className="font-body">{item.label}</span>
                                {isActive && (
                                    <div className="absolute -top-0.5 left-1/2 -translate-x-1/2 w-5 h-0.5 rounded-full bg-balance-gold" />
                                )}
                            </Link>
                        );
                    })}
