                    ...
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Link to="/coach" className="flex items-center space-x-2.5">
                                ...
                                />
                                <span className="font-heading text-xl font-bold text-balance-gold">Balance Room</span>
                            ...
                            <div className="flex h-16 items-center justify-between border-b px-4">
                                <div className="flex items-center space-x-2">
                                    <img 
                                        ...
                                        className="h-10 w-auto object-contain"
                                    />
                                    <span className="font-heading text-lg font-bold text-balance-gold">Balance Room Coach</span>
                                </div>
                                <Button
                                    variant="ghost"
                                    size="icon"
