            ...
            <AdminLayout>
                <div className="space-y-6">
                    ...
                    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-balance-dark via-[#3D3229] to-balance-dark p-6 sm:p-8">
                        <div className="absolute top-0 right-0 w-64 h-64 rounded-full bg-balance-gold/[0.08] blur-3xl" />
                        <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full bg-balance-olive/[0.1] blur-3xl" />
                        <div className="relative z-10">
                            <div className="flex items-center gap-2 mb-1">
                                <Sparkles className="h-4 w-4 text-balance-gold/60" />
                    ...
                    {pendingVerificationOrders.length > 0 && (
                        <div className="bg-balance-olive/10 border border-balance-olive/30 text-foreground p-4 rounded-xl flex items-center justify-between animate-fade-in">
                            <div className="flex items-center gap-3">
                                <div className="h-10 w-10 rounded-full bg-balance-olive/15 flex items-center justify-center shrink-0">
                                    <Banknote className="h-5 w-5 text-balance-olive" />
                                </div>
                            ...
                            <Button variant="default" size="sm" className="bg-balance-olive hover:bg-balance-olive/90 rounded-xl" asChild>
                        ...
                        {[
                            {
                                ...
                                icon: Calendar,
                                color: 'bg-balance-gold/10 text-balance-gold',
                                border: 'border-balance-gold/20',
                            },
                            {
                                title: 'Reservas',
                                ...
                                icon: Users,
                                color: 'bg-balance-olive/10 text-balance-olive',
                                border: 'border-balance-olive/20',
                            },
                            {
                                    ...
                                    {membershipsLoading ? (
                                        ...
                                        recentMemberships.map((membership) => (
                                            <div key={membership.id} className="flex items-start gap-4 p-3 rounded-xl bg-muted/30 hover:bg-muted/50 transition-colors">
                                                <div className="h-9 w-9 rounded-xl bg-balance-gold/10 flex items-center justify-center mt-0.5 shrink-0">
                                                    <UserPlus className="h-4 w-4 text-balance-gold" />
                                                </div>
                                    ...
                                    {ordersLoading ? (
                                        ...
                                        {pendingVerificationOrders.slice(0, 5).map((order) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-sm font-semibold font-body group-hover:text-balance-gold transition-colors">
                                                        {order.user_name}
                                                    </p>
                                                    <p className="text-xs text-muted-foreground font-body">
                                                ...
                                                <div className="text-right shrink-0">
                                                    <Badge variant="outline" className={`text-[10px] rounded-lg ${order.status === 'pending_verification' ? 'bg-warning/10 text-warning border-warning/30' : 'bg-balance-olive/10 text-balance-olive border-balance-olive/30'}`}>
