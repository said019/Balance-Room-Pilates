...
type FoundingMember={id:string;user_id:string;display_name:string;member_number:number;current_cycle:number;effective_status:'active'|'lost'|'expired';activated_on:string;paid_through:string;benefit_ends_on:string};
