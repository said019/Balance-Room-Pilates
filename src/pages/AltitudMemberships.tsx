...
export default function AltitudMemberships() {
  return <div className="alt-site"><SiteHeader /><main className="alt-membership-page alt-pricing-page">
    <header className="alt-pricing-heading"><div><div className="alt-eyebrow">CONSTANCIA QUE SE CONVIERTE EN PROGRESO</div><h1>Encuentra<br /><span>tu ritmo.</span></h1></div><div><p>Consulta los paquetes que el studio tiene disponibles y elige cómo quieres entrenar.</p><Link className="alt-button alt-button-olive" to="/app/checkout">Elegir mi paquete <Arrow /></Link></div></header>
    <PriceTable />
    <div className="alt-payment-note"><div><h2>Tu siguiente paso</h2><p>Inicia sesión para consultar las opciones de compra disponibles. Si necesitas ayuda para comenzar, escríbenos.</p></div><a className="alt-text-link" href={STUDIO.whatsappHref} target="_blank" rel="noopener noreferrer">Hablar con el studio <Arrow diagonal /></a></div>
    <FoundingOffer />
