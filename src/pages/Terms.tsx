...
export default function Terms() {
  return <div className="alt-site"><SiteHeader /><main className="alt-legal"><div className="alt-eyebrow">2707 ALTITUD</div><h1>Condiciones del studio</h1>
    <h2>Reservaciones y asistencia</h2><p>Inicia sesión para reservar una clase disponible. Los grupos son de hasta {STUDIO.capacity} personas. Cancela o reagenda con mínimo {STUDIO.cancellationHours} horas de anticipación; las cancelaciones tardías y las inasistencias cuentan como una clase utilizada y no se recuperan.</p>
