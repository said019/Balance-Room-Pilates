                        ...
                        <div className="bg-background rounded-lg border p-8 lg:p-12 space-y-12">
                            ...
                            <section id="intro" className="space-y-4">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Bienvenido a Balance Room Pilates. Al acceder a nuestras instalaciones, utilizar nuestros servicios
                            ...
                            <section id="servicios" className="space-y-4">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Balance Room Pilates ofrece clases de entrenamiento físico (incluyendo pero no limitado a Pilates,
                                    Yoga, y Barre o Balance Room), talleres y eventos relacionados con el bienestar.
                                </p>
                                <p className="text-muted-foreground leading-relaxed">
                            ...
                            <section id="responsabilidad" className="space-y-4">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    El usuario reconoce que la práctica de ejercicio físico conlleva riesgos inherentes. Balance Room Pilates
                            ...
                            <section id="cambios" className="space-y-4">
                                ...
                                <p className="text-muted-foreground leading-relaxed">
                                    Balance Room Pilates se reserva el derecho de modificar estos términos y condiciones en cualquier momento.
