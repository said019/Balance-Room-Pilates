                    ...
                    <div className="bg-background rounded-lg border p-8 lg:p-12 space-y-10">
                        <div className="space-y-4 pb-8 border-b">
                            ...
                            <p className="text-muted-foreground leading-relaxed">
                                En Balance Room Pilates cuidamos el tiempo de cada alumna y coach. Las clases tienen
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4 p-5 rounded-xl border bg-emerald-50/50 border-emerald-200 dark:bg-emerald-950/10 dark:border-emerald-800">
                                ...
                                <div>
                                    <h3 className="font-semibold text-base mb-1">Cancelación con 5 horas o más</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Si cancelas al menos 5 horas antes de la clase, el crédito vuelve a tu paquete.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4 p-5 rounded-xl border bg-red-50/50 border-red-200 dark:bg-red-950/10 dark:border-red-800">
                                ...
                                <div>
                                    <h3 className="font-semibold text-base mb-1">Cancelación con menos de 5 horas</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                            ...
                            <div className="overflow-hidden rounded-xl border">
                                <table className="w-full text-sm">
                                    ...
                                    <tbody className="divide-y">
                                        <tr>
                                            <td className="px-4 py-3 text-muted-foreground">5 horas o más antes de clase</td>
                                            <td className="px-4 py-3 text-emerald-600 font-medium">Se devuelve</td>
                                        </tr>
                                        <tr>
                                            <td className="px-4 py-3 text-muted-foreground">Menos de 5 horas antes de clase</td>
