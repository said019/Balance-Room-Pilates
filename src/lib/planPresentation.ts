...
export const packagePresentations: Record<PackageType, PackagePresentation> = {
  ...
  individual: {
    ...
    accentLabel: 'enfoque',
    surface: 'bg-[#E9E4D8]',
    panel: 'bg-[#F4F0E7] text-[#332A22] ring-[#7E8579]/22',
    card: 'bg-[#FCFAF5] text-[#332A22] ring-[#A9AD9D]/35 hover:ring-[#7E8579]/55',
  ...
  mixto: {
    ...
    surface: 'bg-[#D9D7CA]',
    panel: 'bg-[#ECE9DB] text-[#292A23] ring-[#9E9275]/25',
    card: 'bg-[#F8F5EA] text-[#292A23] ring-[#B8AA86]/35 hover:ring-[#8E8266]/55',
    chip: 'bg-[#6E6E58] text-[#FBF8F2]',
    badge: 'bg-[#E8DFC7] text-[#665B41] ring-[#9E9275]/22',
    cta: 'bg-[#6E6E58] text-[#FBF8F2] hover:bg-[#5F604B]',
    dot: 'bg-[#9E9275]',
    text: 'text-[#5F5949]',
  },
};
