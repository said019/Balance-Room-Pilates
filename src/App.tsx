...
function WhatsAppFloatingButton() {
  ...
  const sitsAboveClientNav = pathname.startsWith('/app') || pathname.startsWith('/client');
  ...
  return (
    <a
      ...
      className={`fixed right-4 z-40 bg-[#25D366] hover:bg-[#1fb855] text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 flex items-center justify-center h-12 w-12 lg:bottom-6 lg:h-14 lg:w-14 ${
        sitsAboveClientNav
