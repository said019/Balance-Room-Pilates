-- ============================================================
-- BALANCE ROOM PILATES — ESQUEMA COMPLETO DE POSTGRESQL
...
CREATE TABLE IF NOT EXISTS events (
    ...
    start_time           TIME NOT NULL,
    end_time             TIME NOT NULL,
    location             VARCHAR(255) DEFAULT 'Balance Room Pilates',
...
VALUES
    ('Yoga', 'Movimiento consciente, respiracion y movilidad.', 'all', 50, 6, 'leaf', '#81836F'),
    ('Hot yoga', 'Secuencias fluidas en ambiente calido.', 'all', 50, 6, 'flame', '#9A8062'),
    ('Pilates mat', 'Core, postura y control con progresiones.', 'all', 50, 6, 'target', '#A2A88B'),
    ('Hot Pilates', 'Pilates con intensidad, calor y energia.', 'all', 50, 6, 'flame', '#A48550'),
    ('Silla wunda', 'Equipo, resistencia y correcciones puntuales.', 'all', 50, 6, 'sparkles', '#6E725F'),
    ('Sculpt', 'Tonificacion full body con fuerza funcional.', 'all', 50, 6, 'waves', '#B49A73'),
    ('Barre', 'Ballet, pilates y pulsos finos para postura.', 'all', 50, 6, 'sparkles', '#8C8475')
ON CONFLICT DO NOTHING;
...
-- --------------------------------------------------------
-- Paquetes Balance Room Pilates
-- --------------------------------------------------------
INSERT INTO plans (name, description, price, currency, duration_days, class_limit, features, is_active, sort_order) VALUES
(
    'Clase suelta',
    '1 clase con vigencia mensual',
    200.00, 'MXN', 30, 1,
    '["1 clase", "Vigencia de 1 mes"]'::jsonb,
    true, 1
),
(
    'Paquete 4 clases',
    '4 clases con vigencia mensual',
    750.00, 'MXN', 30, 4,
    '["4 clases", "Vigencia de 1 mes"]'::jsonb,
    true, 2
),
(
    'Paquete 8 clases',
    '8 clases con vigencia mensual',
    1450.00, 'MXN', 30, 8,
    '["8 clases", "Vigencia de 1 mes", "Paquete recomendado"]'::jsonb,
    true, 3
),
(
    'Paquete 12 clases',
    '12 clases con vigencia mensual',
    2100.00, 'MXN', 30, 12,
    '["12 clases", "Vigencia de 1 mes"]'::jsonb,
    true, 4
),
(
    'Paquete 24 clases',
    '24 clases con vigencia mensual',
    2900.00, 'MXN', 30, 24,
    '["24 clases", "Vigencia de 1 mes", "Mejor costo por clase"]'::jsonb,
    true, 5
)
ON CONFLICT DO NOTHING;
...
(
    'studio_info',
    '{"name": "Balance Room Pilates", "address": "Hermenegildo Galeana Int. Local 4, Centro, 76803 San Juan del Río, Qro.", "phone": "+52 427 100 7347", "email": "hola@balanceroom.mx", "social_media": {"instagram": "@balanceroom.pilates"}}'::jsonb,
    'Información del estudio'
),
(
    'booking_policies',
    '{"cancellation_hours": 5, "no_show_penalty": true, "max_advance_days": 14, "credits_validity_days": 30, "allow_reschedule": false}'::jsonb,
...
-- GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO balance_app;
-- GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO balance_app;
-- GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO balance_app;
...
DO $$
BEGIN
    RAISE NOTICE '✅ Balance Room Pilates - Esquema completo cargado correctamente.';
