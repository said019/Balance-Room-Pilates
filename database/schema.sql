...
('Clase suelta', '1 clase con vigencia mensual', 200.00, 30, 1, '["1 clase", "Vigencia de 1 mes"]', 1),
('Paquete 4 clases', '4 clases con vigencia mensual', 750.00, 30, 4, '["4 clases", "Vigencia de 1 mes"]', 2),
('Paquete 8 clases', '8 clases con vigencia mensual', 1450.00, 30, 8, '["8 clases", "Vigencia de 1 mes", "Paquete recomendado"]', 3),
('Paquete 12 clases', '12 clases con vigencia mensual', 2100.00, 30, 12, '["12 clases", "Vigencia de 1 mes"]', 4),
('Paquete 24 clases', '24 clases con vigencia mensual', 2900.00, 30, 24, '["24 clases", "Vigencia de 1 mes", "Mejor costo por clase"]', 5);

-- Insert default system settings
INSERT INTO system_settings (key, value, description) VALUES
('studio_info', '{"name": "Balance Room Pilates", "address": "Hermenegildo Galeana Int. Local 4, Centro, 76803 San Juan del Río, Qro.", "phone": "+52 427 100 7347", "email": "hola@balanceroom.mx", "social_media": {"instagram": "@balanceroom.pilates"}}', 'Información del estudio'),
('booking_policies', '{"cancellation_hours": 5, "no_show_penalty": true, "max_advance_days": 14, "credits_validity_days": 30, "allow_reschedule": false}', 'Políticas de reservación'),
