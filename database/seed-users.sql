-- ============================================
-- USUARIOS DE PRUEBA - Balance Room Pilates
-- ============================================

-- Primero eliminar usuarios de prueba existentes (si existen)
DELETE FROM users WHERE email IN ('admin@balanceroom.mx', 'usuario@balanceroom.mx');
...
SELECT 
    ...
    created_at
FROM users 
WHERE email IN ('admin@balanceroom.mx', 'usuario@balanceroom.mx', 'instructor@balanceroom.mx')
ORDER BY role DESC;
