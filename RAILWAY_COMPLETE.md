...
3. Busca y selecciona tu repo **"Balance Room"**
...
- Copia la URL (ej: `balance-room-backend-production.up.railway.app`)
...
2. Selecciona el mismo repo **"Balance Room"** (sí, otra vez)
...
```bash
VITE_API_URL=https://balance-room-backend-production.up.railway.app
...
- Copia la URL (ej: `balance-room-production.up.railway.app`)
...
4. Ejemplo: `https://balance-room-production.up.railway.app`
...
| Backend | `https://balance-room-backend-xxx.railway.app` | API REST |
| Frontend | `https://balance-room-xxx.railway.app` | Sitio web público |
...
FRONTEND_URL=https://balance-room-production.up.railway.app
```
...
3. Add Custom Domain: `balanceroom.mx`
...
- Sitio web: `https://balance-room-production.up.railway.app`
- API: `https://balance-room-backend-production.up.railway.app/api`
